...
#                                                    "DroidSansMono.ttf"))
FONT_PATH = os.environ.get("FONT_PATH", u"/Library/Fonts/ヒラギノ角ゴシック W4.ttc")
...
class WordCloud(object):
    ...
    def __init__(self, font_path=None, width=400, height=200, margin=1,
                 ranks_only=None, prefer_horizontal=.9, mask=None, scale=1,
                 color_func=None, max_words=200, min_font_size=1,
